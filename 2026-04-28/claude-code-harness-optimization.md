...
created: 2026-04-28
description: "Same PM workflow as my $750/mo era. Anthropic fixed 3 bugs. The 4 root causes still on your side, with copy-paste templates.I'm on Claude Co..."
tags:
  - "clippings"
---
![Image](https://pbs.twimg.com/media/HGz4TSQXAAABX3O?format=jpg&name=large)
...
Between March 23 and April 23, some users on Max burned weekly quotas in 1-2 days. Anthropic shipped 3 bug fixes (**v2.1.116+**) and reset all subscriber limits. Full writeup in their [April 23 postmortem](https://x.com/ClaudeDevs/status/2047371123185287223).
...
![Image](https://pbs.twimg.com/media/HGxtdVxXcAAO7ht?format=jpg&name=large)
...
Thariq spelled out the rules in ["Lessons from Building Claude Code"](https://x.com/trq212/status/2024574133011673516). The two that move the needle:
...
![Image](https://pbs.twimg.com/media/HGx_ZlnWUAAJscG?format=jpg&name=large)

Source: Lessons from Building Claude Code: Prompt Caching Is Everything by Thariq ([https://x.com/trq212/status/2024574133011673516](https://x.com/trq212/status/2024574133011673516))
...
On 200K, auto-compact fires at ~155K (~80%), the behavior Boris Cherny [described](https://x.com/bcherny/status/1977163445205450783) for the previous Opus. The trick is to compact before you hit the auto-trigger. Once it fires, it pushes you over and warms a fresh prefix. Compact early instead.
...
![Image](https://pbs.twimg.com/media/HGxsZ2JbgAA7fh7?format=jpg&name=large)

Source: Using Claude Code: Session Management & 1M Context by Thariq ([https://x.com/trq212/status/2044548257058328723](https://x.com/trq212/status/2044548257058328723))
...
- [rtk-ai/rtk](https://github.com/rtk-ai/rtk). CLI proxy that strips redundant whitespace and compresses tool output. ~20-30% token reduction in my measurements.

![Image](https://pbs.twimg.com/media/HGyIvTDa0AAqQJF?format=jpg&name=large)

- [juliusbrussee/caveman](https://github.com/juliusbrussee/caveman). Terse-output skill. Drops conversational filler from responses without affecting the model's actual reasoning.

![Image](https://pbs.twimg.com/media/HGyI5iWa0AAqsJY?format=jpg&name=large)
...
![Image](https://pbs.twimg.com/media/HGxszmCbYAAMpyn?format=jpg&name=large)

Source: Introducing Claude Opus 4.7 ([https://www.anthropic.com/news/claude-opus-4-7](https://www.anthropic.com/news/claude-opus-4-7))
...
[tirth8205/code-review-graph](https://github.com/tirth8205/code-review-graph) builds a persistent AST map of your codebase. Claude reads only what matters. Claimed 6.8× fewer tokens on reviews, up to 49× on daily coding tasks.

![Image](https://pbs.twimg.com/media/HGyEZQ5bYAMVHgz?format=jpg&name=large)
...
[phuryn/claude-usage](https://github.com/phuryn/claude-usage)**:** Long-term breakdown by session, day, week, and all-time. Use it to find where the spend went.

![Image](https://pbs.twimg.com/media/HGyHBPKXMAAIFOW?format=jpg&name=large)

[https://github.com/phuryn/claude-usage](https://github.com/phuryn/claude-usage)

## 5.2 Real-Time

[Gronsten/claude-usage-monitor](https://github.com/Gronsten/claude-usage-monitor)**:** Current 5-hour window + active session tokens, with color thresholds. Use it to know how close you are to your cap right now.

![Image](https://pbs.twimg.com/media/HGyIXwcawAAK4o-?format=jpg&name=large)

[https://github.com/Gronsten/claude-usage-monitor](https://github.com/Gronsten/claude-usage-monitor)
...
![Image](https://pbs.twimg.com/media/HGyH_ppWYAA2wsq?format=jpg&name=large)

Anthropic's Own Cache Dashboard (API users)
...
BTW. On May 9 my Hands-On Claude Code Certification opens. 4 weeks. You ship full agentic products with Claude Code: UI, agentic harness, evals, guardrails, ops. Real apps, not demos. No coding experience required. 40% off till Wednesday → [https://go.productcompass.pm/claudathon](https://go.productcompass.pm/claudathon)